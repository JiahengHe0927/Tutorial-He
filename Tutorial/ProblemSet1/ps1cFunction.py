...
while (current_savings < down_payment - error) or (current_savings > down_payment + error): 
    ...
    current_savings = calculate_salary_over_years(annual_salary_iterate, monthly_salary_iterate, (current_rate/decimal), plan_month, r, total_month_a_year, semi_annual_raise)
